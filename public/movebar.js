(function(){
  ...
  function attach(){
    ...
    bar.innerHTML = '📢 AI Business has a new permanent home! Visit <a href="'+target+'" style="color:#7dd3fc;font-weight:700">www.ai-business.com.ng</a> — taking you there in <b id="movebar_n">10</b>s… <span style="opacity:.85">(Tip: once there, browser menu → Add to Home Screen for your new app icon.)</span>…';
