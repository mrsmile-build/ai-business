...
### NOW — Booking & activity analytics (active)
Read-only dashboards over bookings + activity log: counts by status (created, confirmed, cancelled, rescheduled), confirmation rate, busiest days and hours, service popularity, revenue from confirmed bookings. Feeds Business Strength Score and Next Best Action later.
