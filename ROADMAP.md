...
Booking & activity analytics is DONE (see DONE section). Candidates: Lead Finder 2.0 / Signal System (NEXT), My Page booking prominence (growth review), Business Strength Score (now possible, analytics exists).
